...
int main()
{
	...
	do{
		...
		else if (menu=='4')
		{
			...
			cout <<"DAILY SELL\n";
			cout<<"---------------------------------------------------"<<endl;
			cout <<setw(10)<<left<< "Name"<<setw(10)<<left<<"Product"<<setw(10)<<left<<"Amount"<<endl;
			cout<<"---------------------------------------------------"<<endl;
			for (int n =0 ;n <count_product;n++)
			{
				cout<<setw(10)<<left<<name[n]<<setw(10)<<left<<product[n]<<setw(10)<<left<<stocks[n];
				cout << endl;
			}
			cout<<"---------------------------------------------------"<<endl;
			cout<<"TOTAL:"<<total_prices<<endl;
			cout<<"---------------------------------------------------"<<endl;
			cin.get();
			cin.ignore();
		}
